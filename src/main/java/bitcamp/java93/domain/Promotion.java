...
public class Promotion extends Trainning {
  ...
  public String toString() {
    return "Promotion [titlePic=" + titlePic + ", tiPic=" + tiPic + ", promotionList=" + promotionList + ", titlePhoto="
        + titlePhoto + ", expire=" + expire + ", pno=" + pno + ", title=" + title + ", pric=" + pric + ", content="
        + content + ", sdt=" + sdt + ", edt=" + edt + ", lat=" + lat + ", lng=" + lng + ", meter=" + meter
        + ", photoList=" + photoList + ", comname=" + comname + ", zipcode=" + zipcode + ", comaddr=" + comaddr
