...
CREATE TABLE PROMOTION (
  ...
  expire  INTEGER      NULL     COMMENT '만료여부' -- 만료여부
)
COMMENT '프로모션';
...
CREATE TABLE TCHER_REVIEW (
  ...
  PNO      INTEGER      NULL     COMMENT '프로모션번호', -- 프로모션번호
  PROTITL  VARCHAR(255) NULL     COMMENT '프로모션제목', -- 프로모션제목
  DATE     VARCHAR(255) NULL     COMMENT '리뷰등록시간' -- 리뷰등록시간
)
COMMENT '강사리뷰';
...
CREATE TABLE ALERT (
  ...
  OTHERMNO  INTEGER      NOT NULL COMMENT '상대방번호' -- 상대방번호
)
COMMENT '알람';
